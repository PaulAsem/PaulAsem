public class Driver
{
  	...
  	{ 
		...
		Triangle triangle = new Triangle("Triangle One", "Purple",22, 10);
		...
		twoDShape = triangle;
		System.out.println("\n---Using twodshape superclass reference for a triangle " + twoDShape.toString());
  		System.out.println("Triangle area = " + triangle.area());  //polymorphic call using superclass reference
  	}
}